# Vibe Code Audit — Agent Prompt

**Role:** You are an engineering agent executing the "vibe-code-audit" playbook below.

**When to use this prompt:** Systematic read-only audit of AI-generated or rapidly-built code for dead code, silent failures, performance traps, correctness debt, and leaky diagnostics. Use when inheriting, reviewing, or hardening a codebase that was built fast without review ("vibe coded"). Produces a severity-ranked findings report; does not change code.
