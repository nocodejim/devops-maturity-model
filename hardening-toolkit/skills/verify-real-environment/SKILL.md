---
name: verify-real-environment
description: Prove a change works by exercising it in the running application before claiming completion — build success, exit code 0, and HTTP 200 are not verification. Use when completing any feature or fix, when reviewing a claim that something "works," or when writing a completion report.
---
